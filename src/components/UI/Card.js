const Card = ({ data, onClick }) => {
  ...
  return (
    <div
      ...
      className={`hover:cursor-pointer hover:bg-gray-100 card-body rounded-lg bg-gray-300 border-4 mx-6 mt-5 mb-10 p-5 ${
        pullOrIssue === "Pull"
          ? "hover:border-red-500 border-red-700"
          : "hover:border-blue-500 border-blue-700"
      }`}
    >
